...
To navigate our codebase with confidence, see :confetti_ball:. more information on how we write our markdown files, see the requirements in [the README](README.md).

We don't accept uneccessary long lines of code that are not needed for solving the issue. Some of the contributions don't even require writing a single line of code :sparkles:.
...
Commit the changes once you are happy with them. Don't forget to [self-review]:zap:.
